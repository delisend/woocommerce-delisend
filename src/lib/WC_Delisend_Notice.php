...
/**
 * Class WC_Delisend_Notice
 * @package Delisend\WC\Lib
 */
class WC_Delisend_Notice {


    /** @var WC_Delisend_Plugin the plugin */
    private $plugin;
    ...
    public function __construct( $plugin ) {
        ...
        add_action( 'wp_ajax_wc_plugin_framework_' . $this->get_plugin_id() . '_dismiss_notice', array( $this, 'handle_dismiss_notice' ) );
    }
    ...
    public function should_display_notice( $message_id, $params = array() ) {
        ...
        if ( $params['always_show_on_settings'] ) {
            return true;
        }
    ...
    public function render_admin_notices( $is_visible = true ) {
        ...
        if ( $is_visible && ! self::$admin_notice_placeholder_rendered ) {
            ...
            echo '<div class="js-wc-' . esc_attr(  WC_Delisend_Utils::get_id_dasherized() ) . '-admin-notice-placeholder"></div>';
    ...
    public function render_admin_notice_js() {
        ...
        $plugin_slug = WC_Delisend_Utils::get_id_dasherized();
    ...
    public function dismiss_notice( $message_id, $user_id = null ) {
        ...
        update_user_meta( $user_id, '_wc_plugin_framework_' . $this->get_plugin_id() . '_dismissed_messages', $dismissed_notices );
         ...
         */
        do_action( 'wc_' . $this->get_plugin_id() . '_dismiss_notice', $message_id, $user_id );
    }
    ...
    public function get_dismissed_notices( $user_id = null ) {
        ...
        $dismissed_notices = get_user_meta( $user_id, '_wc_plugin_framework_' . $this->get_plugin_id() . '_dismissed_messages', true );
     ...
     * Get the plugin
     *
     * @return WC_Delisend_Plugin returns the plugin instance
     */
    protected function get_plugin() {
        return WC_Delisend_Helper::wc_delisend();
    }
    ...
    protected function get_plugin_id() {
        return WC_Delisend_Definitions::PLUGIN_ID;
    }
}

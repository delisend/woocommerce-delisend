...
if (!class_exists('WC_Delisend_Message')) :
    ...
    class WC_Delisend_Message
    {
         ...
         */
        public function clear_messages(string $id): void
        {
         ...
         */
        public function add_info($message): void
        {
            $this->infos[] = $message;
        }
         ...
         * @return string
         */
        public function get_warning($index): string
        {
         ...
         * @since 1.0.0
         */
        public function get_message($index): string
        {
         ...
         * }
         */
        public function show_messages(array $params = []): void
        {
